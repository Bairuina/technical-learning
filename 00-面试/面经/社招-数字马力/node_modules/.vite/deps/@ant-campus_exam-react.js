...
// node_modules/@ant-campus/exam-react/dist/index.es.js
...
var Markdown = ({
  ...
  const [markdownHTML, setMarkdownHTML] = (0, import_react.useState)("");
  (0, import_react.useEffect)(() => {
    if (text) {
      setMarkdownHTML(marked(text.trim()));
    }
  }, [text]);
  return jsxs("div", {
    className: "markdown-body",
    children: [before, jsx("article", {
  ...
  return jsx("div", {
    children: jsx(Markdown, {
      ...
      children: jsx("div", {
        style: {
          padding: 30,
          border: "2px solid rgb(75,92,250)"
        },
        children: render ? render() : loading ? "\u8FD0\u884C\u4E2D" : result ? jsx("strong", {
          style: {
            color: "green"
          },
          children: "\u901A\u8FC7"
...
var Paper = ({
  ...
  return jsx("div", {
    children: exams.map((exam, index) => {
      if ((0, import_react.isValidElement)(exam)) {
        return (0, import_react.cloneElement)(exam, {
          key: "r-exam-" + index
        });
      }
      return jsx(Exam, __spreadValues({}, exam), index);
    })
  });
};
export {
 ...
 */
//# sourceMappingURL=@ant-campus_exam-react.js.map
